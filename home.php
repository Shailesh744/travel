    ...
    <section class="footer">
        <div class="box-container">
            ...
            <div class="box">
                ...
                <a href="#"> <i class="fas fa-phone"></i>+91-9369744242</a>
                <a href="#"> <i class="fas fa-envelope"></i>shaileshsinghamir@gmail.com</a>
                <a href="#"> <i class="fas fa-map"></i>varanasi,uttarpradesh-221005</a>
                
            </div>

            <div class="box">
                <h3>Follow Us</h3>
                <a href="#"> <i class="fab fa-facebook-f"></i>shaiilesh</a>
                <a href="#"> <i class="fab fa-twitter"></i>@_shailesh</a>
                <a href="#"> <i class="fab fa-instagram"></i>@_shaileshj</a>
        ...
        <div class="credit">Created by <span>shailesh_singh</span> | All rigths reserved</div>
